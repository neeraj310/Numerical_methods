function [x , err , iter ]= gaussnewton (r , jr , x0 , tol ,kmax , varargin )
...
x = xk ; iter = k ;
if ( k == kmax && err > tol )
    fprintf (["Gauss - Newton method stopped \ n ",...
        " without converging to the desired tolerance \ n" ,...
        "because the maximum number of iterations was \ n" ,...
        " reached \ n "]);
end
end